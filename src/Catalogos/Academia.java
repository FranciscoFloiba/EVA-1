 ...
 * @author Paul
 */
public class Academia extends javax.swing.JDialog {
    private String accion;
    public Conexion enlace;
    public Academias padre;
    ...
    private void initComponents() {
        ...
        nombre.setBounds(230, 210, 310, 28);
        ...
        boton_guardar.setBounds(270, 280, 130, 40);
        ...
        boton_cancelar.setBounds(410, 280, 130, 40);
    ...
    private void boton_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_guardarActionPerformed
      ...
      {
          JOptionPane.showMessageDialog(this, "No se capturó el nombre de la Academia",
                                              "Mensaje", JOptionPane.WARNING_MESSAGE);
          nombre.requestFocus();
          return;
      }            
   ...
   public void cargarCampos(int idx)
    {
        Datos.Academia oAcademia = new Datos.Academia(enlace);
        oAcademia.Buscar(idx);
        institucion.setSelectedItem(new ListaEleccion(oAcademia.getInstitucion_id(),""));
        carrera.setSelectedItem(new ListaEleccion(oAcademia.getCarrera_id(),""));        
        id.setText(Integer.toString(oAcademia.getID()));        
        nombre.setText(oAcademia.getNombre());
   } 
