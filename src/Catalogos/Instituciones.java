 ...
 * @author Paul Benitez
 */
public final class Instituciones extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pie.setPreferredSize(new java.awt.Dimension(381, 111));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(pie, javax.swing.GroupLayout.DEFAULT_SIZE, 874, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(pie, 105, 105, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void BotonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonNuevoActionPerformed
        ...
        dlg = new Catalogos.Institucion();
        dlg.enlace=database;
        dlg.configurarPara("NUEVO");
        dlg.setTitle("Nueva Institución");
        dlg.padre = this;    
    ...
    private void BotonBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBajaActionPerformed
        ...
        if (registroActivo == -1)
        {
            JOptionPane.showMessageDialog(this, "No se ha seleccionado ninguna Institución",
        ...
        dlg.setTitle("Eliminar Institución");
        dlg.padre = this;
    ...
    private void BotonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEditarActionPerformed
        ...
        dlg.setTitle("Actualizar Institución");
        dlg.padre = this;        
        int idx;    
        idx = tabla.convertRowIndexToModel(registroActivo);
        idx = (int)((ModeloTabla)tabla.getModel()).getValueAt(idx, 0);
    ...
    public void cargarTabla()
    {
      ...
      Datos.Institucion oInstitucion = new Datos.Institucion(database);
      ...
      try {
          ...
          if (filtrar) 
          {
            ...
            registros = oInstitucion.DataSetInstitucion(CajaBusqueda.getText(), campo.getSelectedIndex()); 
          }  
          else
          {
            registros = oInstitucion.DataSetInstitucion();
          }
      } catch (SQLException ex) {
          Logger.getLogger(Instituciones.class.getName()).log(Level.SEVERE, null, ex);
      }
