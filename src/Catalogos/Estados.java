 ...
 * @author Paul Benitez
 */
public final class Estados extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setNormalBounds(new java.awt.Rectangle(0, 0, 820, 0));
        ...
        cuerpo.setPreferredSize(new java.awt.Dimension(884, 415));
        ...
        pie.setPreferredSize(new java.awt.Dimension(884, 94));
    ...
    private void BotonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonNuevoActionPerformed
        ...
        dlg = new Catalogos.Estado();
        dlg.enlace=database;
        dlg.configurarPara("NUEVO");        
        dlg.setTitle("Nuevo Estado");
        dlg.padre = this;    
    ...
    private void BotonBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBajaActionPerformed
        ...
        if (registroActivo == -1)
        {
            JOptionPane.showMessageDialog(this, "No se ha seleccionado ningún Estado",
    ...
    private void BotonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEditarActionPerformed
        ...
        dlg.setTitle("Actualizar Estado");
        dlg.padre = this;
    ...
    {
       // Ejecutar metodo para recuperar los registros de la tabla de Estados
      Datos.Estado oEstado = new Datos.Estado(database);
      ...
      try {
          ...
          if (filtrar) 
          {
            ...
            registros = oEstado.DataSetEstado(CajaBusqueda.getText(), campo.getSelectedIndex()); 
          }  
          else
          {
            registros = oEstado.DataSetEstado();
          }
