 ...
 * @author Paul Benitez
 */
public final class Academias extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        campo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ID", "Nombre", "Carrera", "Institución" }));
    ...
    private void BotonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonNuevoActionPerformed
        ...
        dlg = new Catalogos.Academia();
        dlg.enlace=database;
        dlg.configurarPara("NUEVO");
        dlg.setTitle("Nueva Academia");
        dlg.padre = this;    
    ...
    private void BotonBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBajaActionPerformed
        ...
        if (registroActivo == -1)
        {
            JOptionPane.showMessageDialog(this, "No se ha seleccionado ninguna Academia",
        ...
        dlg.setTitle("Eliminar Academia");
        dlg.padre = this;
    ...
    private void BotonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEditarActionPerformed
        ...
        dlg.setTitle("Actualizar Academia");
        dlg.padre = this;        
        int idx;    
        idx = tabla.convertRowIndexToModel(registroActivo);
        idx = (int)((ModeloTabla)tabla.getModel()).getValueAt(idx, 0);
    ...
    {
       // Ejecutar metodo para recuperar los registros de la tabla de Academia
      Datos.Academia oAcademia = new Datos.Academia(database);
      ...
      try {
          ...
          if (filtrar) 
          {
            ...
            registros = oAcademia.DataSetAcademia(CajaBusqueda.getText(), campo.getSelectedIndex()); 
          }  
          else
          {
            registros = oAcademia.DataSetAcademia();
          }
      ...
      try 
        ...
        {
         Logger.getLogger(Academias.class.getName()).log(Level.SEVERE, null, ex);
        }
