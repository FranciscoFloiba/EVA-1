 ...
 * @author Paul Benitez
 */
public final class Instrumentos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Instrumentos de evaluación");
        ...
        campo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ID", "Nombre", "Egel" }));
    ...
    private void BotonNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonNuevoActionPerformed
        ...
        dlg = new Catalogos.Instrumento();
        dlg.enlace=database;
        dlg.configurarPara("NUEVO");
        dlg.setTitle("Nuevo Instrumento");
        dlg.padre = this;    
    ...
    private void BotonBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBajaActionPerformed
        ...
        if (registroActivo == -1)
        {
            JOptionPane.showMessageDialog(this, "No se ha seleccionado ningún Instrumento",
        ...
        dlg.setTitle("Eliminar Instrumento");
        dlg.padre = this;
    ...
    private void BotonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEditarActionPerformed
        ...
        dlg.setTitle("Actualizar Instrumento");
        dlg.padre = this;        
        int idx;      
        idx = tabla.convertRowIndexToModel(registroActivo);
        idx = (int)((ModeloTabla)tabla.getModel()).getValueAt(idx, 0);
    ...
    {
       // Ejecutar metodo para recuperar los registros de la tabla de Instrumento
      Datos.Instrumento oInstrumento = new Datos.Instrumento(database);
      ...
      try {
          ...
          if (filtrar) 
          {
            ...
            registros = oInstrumento.DataSetInstrumento(CajaBusqueda.getText(), campo.getSelectedIndex()); 
          }  
          else
          {
            registros = oInstrumento.DataSetInstrumento();
          }
      } catch (SQLException ex) {
          Logger.getLogger(Instrumentos.class.getName()).log(Level.SEVERE, null, ex);
      }
